...
grep -q 'printf performance' systemd-system/rkwebscr-performance.service
...
grep -q '^rkwebscr (0.3.5)' debian/changelog
grep -q 'server_version = "rkwebscr/0.3.5"' server/rkwebscrd.py
